...
allowed, with the exception of array \ttt{length}.
...
\ttt{Method}s, and after type checking for \ttt{Block} and
\ttt{Statement}. This is a result of the requirement that
