...
{:reductions=>
  [{[:EndProgram,
   ...
   {[:Semicolon,
     ...
     :Divide,
     :Modulo]=>[:Term, 6]},
   {[:CloseParen, :OpenStaple, :Equals]=>[:ArrayType, 3]},
   {[:CloseParen, :OpenStaple, :Equals]=>[:ArrayType, 3]},
   {},
   {},
   {[:CloseParen,
   ...
   {[:CloseParen,
     ...
     :OpenStaple,
     :Equals]=>[:Term, 6]},
   {[:CloseStaple, :Equals]=>[:ArrayType, 3]},
   {[:CloseStaple, :Equals]=>[:ArrayType, 3]},
   {},
   {},
   {[:CloseStaple,
   ...
   {[:Dot,
     ...
     :Modulo,
     :Equals]=>[:ArrayCreator, 3]},
   {[:CloseParen, :Comma, :Equals]=>[:ArrayType, 3]},
   {[:CloseParen, :Comma, :Equals]=>[:ArrayType, 3]},
   {},
   {},
   {[:CloseParen,
 ...
 :transitions=>
  [{:CompilationUnit=>1,
   ...
   {:Expression=>272,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>274, :Selector=>275, :Dot=>276, :OpenStaple=>277},
   {},
   {:Creator=>278,
    :BasicType=>279,
   ...
   {},
   {},
   {:CloseParen=>288, :OpenStaple=>289},
   {:CloseParen=>290, :OpenStaple=>291},
   {},
   {:Equals=>292},
   {},
   {},
   ...
   {:Expression=>296,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>298, :Selector=>299, :Dot=>300, :OpenStaple=>301},
   {:OpenStaple=>302, :Arguments=>303, :OpenParen=>304},
   {},
   {:Creator=>305,
    :BasicType=>306,
   ...
   {},
   {},
   {:Selectors=>309, :Selector=>233, :Dot=>234, :OpenStaple=>235},
   {:Identifier=>310},
   {:Expression=>311,
    :Assignment=>312,
    :SubExpression=>313,
   ...
   {:CloseStaple=>330,
    ...
    :True=>328,
    :False=>329},
   {:Selectors=>332, :Selector=>233, :Dot=>234, :OpenStaple=>235},
   {:CloseParen=>333,
    :Expressions=>334,
    :Expression=>335,
    :Assignment=>336,
    ...
    :False=>353},
   {},
   {:ArrayCreator=>354, :OpenStaple=>355},
   {:ArrayCreator=>356, :Arguments=>357, :OpenStaple=>355, :OpenParen=>238},
   {},
   {},
   {},
   {},
   {},
   {:Dot=>358},
   {:QualifiedIdentifier=>359, :Identifier=>138},
   {},
   {},
   {},
   {:Semicolon=>360},
   ...
   {},
   {:Semicolon=>374},
   {:OpenStaple=>375, :Arguments=>263, :OpenParen=>264},
   {:Dot=>376},
   {},
   {:CloseStaple=>377,
    :Expression=>378,
    ...
    :True=>328,
    :False=>329},
   {:Selectors=>379, :Selector=>275, :Dot=>276, :OpenStaple=>277},
   {:CloseParen=>380,
    :Expressions=>381,
    :Expression=>335,
    :Assignment=>336,
   ...
   {:Expression=>383,
    ...
    :True=>180,
    :False=>181},
   {:QualifiedIdentifier=>384, :Identifier=>167},
   {:ArrayType=>385,
    :BasicType=>386,
    :QualifiedIdentifier=>387,
    :Byte=>242,
    :Char=>243,
    :Int=>244,
    :Boolean=>245,
   ...
   {:SubExpression=>388,
    ...
    :False=>181},
   {},
   {:CloseParen=>389, :OpenStaple=>390},
   {:CloseParen=>391, :OpenStaple=>392},
   {},
   {:Selectors=>393, :Selector=>275, :Dot=>276, :OpenStaple=>277},
   {:Identifier=>394},
   {:Expression=>395,
    :Assignment=>312,
    :SubExpression=>313,
    ...
    :False=>329},
   {},
   {:ArrayCreator=>396, :OpenStaple=>397},
   {:ArrayCreator=>398, :Arguments=>399, :OpenStaple=>397, :OpenParen=>264},
   {},
   {},
   {},
   {:OpenStaple=>400},
   ...
   {:SubExpression=>411,
    ...
    :False=>231},
   {},
   {:CloseParen=>412, :OpenStaple=>413},
   {:CloseParen=>414, :OpenStaple=>415},
   {},
   {:Selectors=>416, :Selector=>299, :Dot=>300, :OpenStaple=>301},
   {:Identifier=>417},
   {:Expression=>418,
    :Assignment=>312,
    :SubExpression=>313,
   ...
   {:CloseStaple=>419,
    ...
    :True=>328,
    :False=>329},
   {:Selectors=>421, :Selector=>299, :Dot=>300, :OpenStaple=>301},
   {:CloseParen=>422,
    :Expressions=>423,
    :Expression=>335,
    :Assignment=>336,
    ...
    :False=>353},
   {},
   {:ArrayCreator=>424, :OpenStaple=>425},
   {:ArrayCreator=>426, :Arguments=>427, :OpenStaple=>425, :OpenParen=>304},
   {:QualifiedIdentifier=>428, :Identifier=>224},
   {},
   {:Arguments=>429, :OpenParen=>238},
   {:CloseStaple=>430},
   {},
   {:Equals=>431},
   {:Instanceof=>432,
   ...
   {:Expression=>455,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>457, :Selector=>458, :Dot=>459, :OpenStaple=>460},
   {:OpenStaple=>461, :Arguments=>462, :OpenParen=>463},
   {},
   {:Creator=>464,
    :BasicType=>465,
   ...
   {},
   {},
   {:QualifiedIdentifier=>469, :Identifier=>247},
   {},
   {},
   {:Expression=>470,
    :Assignment=>165,
   ...
   {:Expression=>476,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>478, :Selector=>479, :Dot=>300, :OpenStaple=>301},
   {:OpenStaple=>480, :Arguments=>481, :OpenParen=>304},
   {:Semicolon=>482},
   {},
   {:VariableDeclarator=>483, :Identifier=>253},
   {:CloseParen=>484},
   {},
   {:CloseStaple=>485,
    :Expression=>378,
    ...
    :True=>328,
    :False=>329},
   {:QualifiedIdentifier=>486, :Identifier=>260},
   {},
   {:CloseStaple=>487},
   {},
   {},
   ...
   {:CloseStaple=>498},
   {:CloseStaple=>499},
   {:QualifiedIdentifier=>500, :Identifier=>286},
   {},
   {:CloseParen=>501},
   {},
   {:CloseParen=>502},
   ...
   {:SubExpression=>518,
    ...
    :False=>329},
   {},
   {:CloseParen=>519, :OpenStaple=>520},
   {:CloseParen=>521, :OpenStaple=>522},
   {},
   {:Selectors=>523, :Selector=>438, :Dot=>439, :OpenStaple=>440},
   {:Identifier=>524},
   {:Expression=>525,
    :Assignment=>312,
    :SubExpression=>313,
   ...
   {:CloseStaple=>526,
    ...
    :True=>328,
    :False=>329},
   {:Selectors=>528, :Selector=>438, :Dot=>439, :OpenStaple=>440},
   {:CloseParen=>529,
    :Expressions=>530,
    :Expression=>335,
    :Assignment=>336,
    ...
    :False=>353},
   {},
   {:ArrayCreator=>531, :OpenStaple=>532},
   {:ArrayCreator=>533, :Arguments=>534, :OpenStaple=>532, :OpenParen=>443},
   {:QualifiedIdentifier=>535, :Identifier=>322},
   {:Selectors=>536, :Selector=>233, :Dot=>234, :OpenStaple=>235},
   {},
   {:Expressions=>537,
    :Expression=>335,
    :Assignment=>336,
   ...
   {:SubExpression=>542,
    ...
    :False=>353},
   {},
   {:CloseParen=>543, :OpenStaple=>544},
   {:CloseParen=>545, :OpenStaple=>546},
   {},
   {:Selectors=>547, :Selector=>458, :Dot=>459, :OpenStaple=>460},
   {:Identifier=>548},
   {:Expression=>549,
    :Assignment=>312,
    :SubExpression=>313,
   ...
   {:CloseStaple=>550,
    ...
    :True=>328,
    :False=>329},
   {:Selectors=>552, :Selector=>458, :Dot=>459, :OpenStaple=>460},
   {:CloseParen=>553,
    :Expressions=>554,
    :Expression=>335,
    :Assignment=>336,
    ...
    :False=>353},
   {},
   {:ArrayCreator=>555, :OpenStaple=>556},
   {:ArrayCreator=>557, :Arguments=>558, :OpenStaple=>556, :OpenParen=>463},
   {:QualifiedIdentifier=>559, :Identifier=>346},
   {:CloseStaple=>560},
   {},
   {},
   {:Statement=>561,
   ...
   {:SubExpression=>574,
    ...
    :False=>231},
   {},
   {:CloseParen=>575, :OpenStaple=>576},
   {:CloseParen=>577, :OpenStaple=>578},
   {},
   {:Selectors=>579, :Selector=>479, :Dot=>300, :OpenStaple=>301},
   {:CloseStaple=>580,
    :Expression=>581,
    :Assignment=>312,
    :SubExpression=>313,
    ...
    :True=>328,
    :False=>329},
   {:Selectors=>582, :Selector=>479, :Dot=>300, :OpenStaple=>301},
   {:Semicolon=>583,
    :Expression=>584,
    :Assignment=>165,
    :SubExpression=>166,
   ...
   {},
   {},
   {:Selectors=>586, :Selector=>275, :Dot=>276, :OpenStaple=>277},
   {},
   {:CloseStaple=>587},
   {:CloseStaple=>588},
   {},
   ...
   {},
   {},
   {:Selectors=>598, :Selector=>299, :Dot=>300, :OpenStaple=>301},
   {},
   {:CloseStaple=>599},
   {},
   {},
   ...
   {},
   {},
   {:Selectors=>649, :Selector=>438, :Dot=>439, :OpenStaple=>440},
   {},
   {:CloseStaple=>650},
   {:CloseStaple=>651},
   {:CloseStaple=>652},
   ...
   {},
   {},
   {:Selectors=>655, :Selector=>458, :Dot=>459, :OpenStaple=>460},
   {},
   {:CloseStaple=>656},
   {:Statement=>657,
    :Block=>156,
   ...
   {},
   {:CloseParen=>666},
   {:Selectors=>667, :Selector=>479, :Dot=>300, :OpenStaple=>301},
   {:CloseParen=>668},
   {},
   {:ForUpdate=>669,
    :Expression=>639,
