...
{:reductions=>
  [{[:EndProgram,
   ...
   {[:Semicolon,
     ...
     :Divide,
     :Modulo]=>[:Term, 6]},
   {[:CloseParen, :OpenStaple, :Equals]=>[:SubExpression, 5]},
   {[:CloseParen,
     :OpenStaple,
     :Equals,
     :LazyOr,
 ...
 :transitions=>
  [{:CompilationUnit=>1,
   ...
   {},
   {},
   {:VariableDeclarator=>253, :Identifier=>254},
   {},
   {:OpenParen=>255},
   {:OpenParen=>256},
   {:OpenParen=>257},
   ...
   {:Expression=>276,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>278, :Selector=>266, :Dot=>268, :OpenStaple=>279},
   {},
   {:Creator=>280,
    :BasicType=>281,
   ...
   {:Expression=>298,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>300, :Selector=>301, :Dot=>302, :OpenStaple=>303},
   {:OpenStaple=>304,
    :Selectors=>305,
    :Arguments=>306,
    :Selector=>301,
   ...
   {},
   {},
   {:Selectors=>312, :Selector=>233, :Dot=>234, :OpenStaple=>235},
   {:Identifier=>313},
   {:Expression=>314,
    :Assignment=>315,
    :SubExpression=>316,
   ...
   {:CloseStaple=>333,
    ...
    :False=>332},
   {},
   {:Selectors=>334, :Selector=>233, :Dot=>234, :OpenStaple=>235},
   {:CloseParen=>335,
    :Expressions=>336,
    :Expression=>337,
    :Assignment=>338,
    ...
    :False=>355},
   {},
   {:ArrayCreator=>356, :OpenStaple=>357},
   {:ArrayCreator=>358, :Arguments=>359, :OpenStaple=>357, :OpenParen=>239},
   {},
   {},
   {},
   {},
   {},
   {:Dot=>360},
   {:QualifiedIdentifier=>361, :Identifier=>138},
   {},
   {},
   {},
   {:Semicolon=>362},
   ...
   {:CloseStaple=>379,
    ...
    :False=>332},
   {},
   {:Selectors=>381, :Selector=>266, :Dot=>268, :OpenStaple=>279},
   {:Selectors=>382, :Selector=>266, :Dot=>268, :OpenStaple=>279},
   {:CloseParen=>383,
    :Expressions=>384,
    :Expression=>337,
    :Assignment=>338,
   ...
   {:Expression=>387,
    ...
    :True=>180,
    :False=>181},
   {:QualifiedIdentifier=>388, :Identifier=>167},
   {:ArrayType=>389,
    :BasicType=>390,
   ...
   {:Expression=>380,
    ...
    :False=>332},
   {},
   {:ArrayCreator=>397, :OpenStaple=>398},
   {:ArrayCreator=>399, :Arguments=>400, :OpenStaple=>398, :OpenParen=>267},
   {},
   {},
   {:Infixop=>401,
    :LazyOr=>191,
   ...
   {:SubExpression=>414,
    ...
    :False=>231},
   {},
   {:CloseParen=>415, :OpenStaple=>416},
   {:CloseParen=>417, :OpenStaple=>418},
   {},
   {:Selectors=>419, :Selector=>301, :Dot=>302, :OpenStaple=>303},
   {:Identifier=>420},
   {:Expression=>421,
    :Assignment=>315,
    :SubExpression=>316,
   ...
   {:CloseStaple=>422,
    ...
    :False=>332},
   {},
   {:Selectors=>423, :Selector=>301, :Dot=>302, :OpenStaple=>303},
   {:CloseParen=>424,
    :Expressions=>425,
    :Expression=>337,
    :Assignment=>338,
    ...
    :False=>355},
   {},
   {:ArrayCreator=>426, :OpenStaple=>427},
   {:ArrayCreator=>428, :Arguments=>429, :OpenStaple=>427, :OpenParen=>307},
   {:QualifiedIdentifier=>430, :Identifier=>224},
   {},
   {:Arguments=>431, :OpenParen=>239},
   {:CloseStaple=>432},
   {},
   {:Equals=>433},
   {:Instanceof=>434,
   ...
   {:Expression=>437,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>439, :Selector=>440, :Dot=>441, :OpenStaple=>442},
   {:OpenStaple=>443,
    :Selectors=>444,
    :Arguments=>445,
    :Selector=>440,
   ...
   {:Expression=>457,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>459, :Selector=>460, :Dot=>461, :OpenStaple=>462},
   {:OpenStaple=>463,
    :Selectors=>464,
    :Arguments=>465,
    :Selector=>460,
   ...
   {},
   {},
   {:QualifiedIdentifier=>472, :Identifier=>248},
   {},
   {},
   {:Expression=>473,
    :Assignment=>165,
   ...
   {:Expression=>479,
    ...
    :True=>230,
    :False=>231},
   {:Selectors=>481, :Selector=>482, :Dot=>302, :OpenStaple=>303},
   {:OpenStaple=>483,
    :Selectors=>484,
    :Arguments=>485,
    :Selector=>482,
   ...
   {:Semicolon=>486},
   {},
   {:VariableDeclarator=>487, :Identifier=>254},
   {:CloseParen=>488},
   {},
   {:CloseStaple=>489,
    :Expression=>380,
    ...
    :True=>331,
    :False=>332},
   {:QualifiedIdentifier=>490, :Identifier=>261},
   {},
   {:CloseStaple=>491},
   {},
   {},
   ...
   {:CloseStaple=>503},
   {:CloseStaple=>504},
   {:QualifiedIdentifier=>505, :Identifier=>288},
   {},
   {:CloseParen=>506},
   {},
   {:CloseParen=>507},
   ...
   {:SubExpression=>523,
    ...
    :False=>332},
   {},
   {:CloseParen=>524, :OpenStaple=>525},
   {:CloseParen=>526, :OpenStaple=>527},
   {},
   {:Selectors=>528, :Selector=>440, :Dot=>441, :OpenStaple=>442},
   {:Identifier=>529},
   {:Expression=>530,
    :Assignment=>315,
    :SubExpression=>316,
   ...
   {:CloseStaple=>531,
    ...
    :False=>332},
   {},
   {:Selectors=>532, :Selector=>440, :Dot=>441, :OpenStaple=>442},
   {:CloseParen=>533,
    :Expressions=>534,
    :Expression=>337,
    :Assignment=>338,
    ...
    :False=>355},
   {},
   {:ArrayCreator=>535, :OpenStaple=>536},
   {:ArrayCreator=>537, :Arguments=>538, :OpenStaple=>536, :OpenParen=>446},
   {:QualifiedIdentifier=>539, :Identifier=>325},
   {},
   {:Expressions=>540,
    :Expression=>337,
    :Assignment=>338,
   ...
   {:SubExpression=>545,
    ...
    :False=>355},
   {},
   {:CloseParen=>546, :OpenStaple=>547},
   {:CloseParen=>548, :OpenStaple=>549},
   {},
   {:Selectors=>550, :Selector=>460, :Dot=>461, :OpenStaple=>462},
   {:Identifier=>551},
   {:Expression=>552,
    :Assignment=>315,
    :SubExpression=>316,
   ...
   {:CloseStaple=>553,
    ...
    :False=>332},
   {},
   {:Selectors=>554, :Selector=>460, :Dot=>461, :OpenStaple=>462},
   {:CloseParen=>555,
    :Expressions=>556,
    :Expression=>337,
    :Assignment=>338,
    ...
    :False=>355},
   {},
   {:ArrayCreator=>557, :OpenStaple=>558},
   {:ArrayCreator=>559, :Arguments=>560, :OpenStaple=>558, :OpenParen=>466},
   {:QualifiedIdentifier=>561, :Identifier=>348},
   {:CloseStaple=>562},
   {},
   {},
   {:Statement=>563,
   ...
   {:CloseParen=>579, :OpenStaple=>580},
   {},
   {:Selectors=>581, :Selector=>482, :Dot=>302, :OpenStaple=>303},
   {:CloseStaple=>582,
    :Expression=>421,
    :Assignment=>315,
    :SubExpression=>316,
    ...
    :False=>332},
   {},
   {:Selectors=>583, :Selector=>482, :Dot=>302, :OpenStaple=>303},
   {:Semicolon=>584,
    :Expression=>585,
    :Assignment=>165,
    :SubExpression=>166,
